<!DOCTYPE html>
        ...
        <div id="loading-page-bb" style="opacity: 0; height: 100%;">
              <div style="width:10px;height:170px;"></div>
  <div id="inicio" class="classe_da_tela" style="background-color: #ffffff; height: 100%; width: auto;">
    <img src="assets/logo11.png" height="250px" width="250px" id="logo">
  </div>
